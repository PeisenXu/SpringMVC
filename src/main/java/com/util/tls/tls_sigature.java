...
public class tls_sigature {
	 ...
	 */
	@Deprecated
	public static CheckTLSSignatureResult CheckTLSSignature( String urlSig, String strAppid3rd, long skdAppid, String identifier, long accountType) throws DataFormatException
	{
		...
		try{
	        ...
	        PublicKey pubKeyStruct  = getPublicKey(ImConfig.QC_PUBLIC_KEY);
	...
	public static GenTLSSignatureResult GenTLSSignatureEx(
		...
		return GenTLSSignatureEx(skdAppid, identifier, 3600 * 24 * 180);
	}
...
//        parser.close();
//    	PrivateKey privKeyStruct = converter.getPrivateKey((PrivateKeyInfo) obj);
		PrivateKey privKeyStruct = getPrivateKey(ImConfig.QC_PRIVATE_KEY);
	...
	public static CheckTLSSignatureResult CheckTLSSignatureEx(String urlSig, long sdkAppid, String identifier) throws DataFormatException {
	...
	public static void main(String[] args) {
		try{
			// generate signature
			GenTLSSignatureResult result = GenTLSSignatureEx(1400023543, "1032348736");
			...
			// check signature
			CheckTLSSignatureResult checkResult = CheckTLSSignatureEx(result.urlSig, 1400023543, "1032348736");
